...
public class GeneralTreeColumnConfig extends TreeColumnConfig {

	public GeneralTreeColumnConfig(TreeViewer viewer) {
		super(viewer);
	}
	...
	protected ColumnLabelProvider createLabelProvider()
	{
      ...
      public void update(ViewerCell cell)
      {
    	...
    	public Font getFont(Object element) {
    		return GeneralTreeColumnConfig.this.getFont(element);
    	}

    	public Color getBackground(Object element) {
    		return GeneralTreeColumnConfig.this.getBackground(element);
    	}

    	public Color getForeground(Object element) {
    		return GeneralTreeColumnConfig.this.getForeground(element);
    	}

    	public Image getImage(Object element) {
    		return GeneralTreeColumnConfig.this.getImage(element);
    	}

    	public String getText(Object element) {
    		return GeneralTreeColumnConfig.this.getText(element);
    	}
		};
		return provider;
	}
...
//////////////////////////////////////////////////////////////////////////
	...
	protected EditingSupport createEditingSupport()
	{
		return new EditingSupport(getViewer()) {
			...
			@Override
			protected boolean canEdit(Object element) {
				return GeneralTreeColumnConfig.this.canEdit(element);
			}
		};
